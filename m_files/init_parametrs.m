...
%% Mereni
% 1) odezva samotné soustavy na impulz - viz příloha
% 2) průběh kmitů kyvadla při nehybném vozíku - viz příloha
% 3) M(vozík) = 1.16 + 0.65 kg; m(závaží) = 0.86 kg; l(kyvadlo) = 410 mm
% 4) F = 3.5 N
% 5) r_p = 0.2115; r_d = 0.0254 


%% State-Space Cart + Pendulum
% Matrix of Dynamicx
% A = [0, 1, 0, 0;
%      0, -f_1k_lin/m1, (m2*g)/m1, f_2k_lin/(m1*l);
%      0, 0, 0, 1;
%      0, f_1k_lin/(l*m1), -((m1+m2)*g)/(l*m1), -(f_2k_lin*(1+m1/m2))/(m1*l^2)];

% Vector of inputs
% B = [0; 1/m1; 0; -1/(l*m1)]; % 1/m1, jsem mel na prvni pozici misto druhe

% Matrix of outputs
% C = [1 0 0 0;
%      0 0 1 0];
% Matrix of input influence on output
% D = [0; 0];
...
% cim vetsi hodnota -> rychlejsi dynamika -> vetsi problem s sumem z mereni
l1 = 10;
l2 = 10; 
L = [l1; l2];
Ahat = A;
